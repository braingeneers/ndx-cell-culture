...
spec_input_spec_dir = str(Path(__file__).resolve().parents[3] / 'spec')

# Name of the YAML file with the specification of the Namespace to be documented
spec_input_namespace_filename = 'ndx-cell-culture.namespace.yaml'

# Name of the default namespace in the file
spec_input_default_namespace = 'ndx-cell-culture'
...
spec_show_hierarchy_plots = False
